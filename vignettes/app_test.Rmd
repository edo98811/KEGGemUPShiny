...
```{r use-package}
devtools::load_all("/Users/edoardofilippi/Development/Projects/KEGGemUP")
devtools::load_all()
KEGGemUPShiny(
  pathway_list = rownames(res_enrich_IFNg_vs_naive_dds)[1:10],
  de_results_list = dde
)
```
...
KEGGemUPShiny(
  pathway_list = rownames(res_enrich_IFNg_vs_naive_dds)[1:10],
  de_results_list = de_results_limma
)
```
